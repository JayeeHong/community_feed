...
class CommentTest {
    ...
    @Test
    void givenCommentCreatedAndLike_whenUnlike_thenLikeCountShuldBe0() {
        // given
        comment.like(otherUser);
    ...
    @Test
    void givenCommentCreated_whenUpdateComment_thenCommentShouldBeUpdated() {
        // given
    ...
    void givenComment_whenUpdateContentOver100_thenThrowException() {
        // given
        String newComment = "a".repeat(101);

        // when, then
        assertThrows(IllegalArgumentException.class, () -> comment.updateComment(user, newComment));
    }
